...
/** Local demo of the same four product tabs when the live site is unreachable. */
export function OfflineOrganizer() {
  ...
  const body = useMemo(() => {
    ...
    return (
      <View style={{ gap: 12 }}>
        ...
        <Text style={{ color: TOKENS.muted }}>
          Offline demo clocks. Open live StatusPass to use your saved dates.
        </Text>
      </View>
    );
